...
class login:
    ...
    def custlog(self):
        ...
        engine.say("Welcome to customer login")
        engine.runAndWait()'''
...
class log:
    ...
    def update_details(self):
        ...
        l17=Label(f6,text="Enter Your PIN",font=("arial",15),bg="#fff",fg="royalblue")
        l17.place(relx=0.5,rely=0.05)
        ...
        c13=Canvas(f6,width=300,height=2,bg="black",highlightthickness=0)
        c13.place(relx=0.6,rely=0.08)
        self.n1=StringVar()
        self.ad1=StringVar()
        self.pn1=StringVar()
        self.em1=StringVar()
        l34=Label(f6,text="Enter Your New Details",font=("arial",15),bg="#fff",fg="royalblue")
        l34.place(relx=0.5,rely=0.2)
        l35=Label(f6,text="Enter Name",font=("arial",15),bg="#fff",fg="royalblue")
        l35.place(relx=0.5,rely=0.25)
        ...
        c3=Canvas(f6,width=300,height=2,bg="black",highlightthickness=0)
        c3.place(relx=0.65,rely=0.28)
        l36=Label(f6,text="Enter Address",font=("arial",15),bg="#fff",fg="royalblue")
        l36.place(relx=0.5,rely=0.31)
        ...
        c3=Canvas(f6,width=300,height=2,bg="black",highlightthickness=0)
        c3.place(relx=0.65,rely=0.34)
        l37=Label(f6,text="Enter Phone Number",font=("arial",15),bg="#fff",fg="royalblue")
        l37.place(relx=0.5,rely=0.37)
        ...
        c3=Canvas(f6,width=300,height=2,bg="black",highlightthickness=0)
        c3.place(relx=0.65,rely=0.4)
        l38=Label(f6,text="Enter E-mail",font=("arial",15),bg="#fff",fg="royalblue")
        l38.place(relx=0.5,rely=0.43)
        ...
        def ud1():
            ...
            if self.name == "" or self.email == "" or self.mobile == "" or self.address=="":
                ...
                db=sqlite3.connect("back.db")
                cr=db.cursor()
                cr.execute("select * from account where email='"+self.e.get()+"' or phno='"+self.pn.get()+"'")
                result = cr.fetchone()
                if result is None:
                    cr=db.cursor()
            ...
            self.em1.set("")
            self.pi1.set("")
        b18=Button(f6,text="Submit",bg="royalblue",fg="white",width=20,height=2,command=ud1)
        b18.place(relx=0.55,rely=0.6)     
        b19=Button(f6,text="Back to Main Menu",bg="red",fg="white",width=20,height=2,command=self.show_main)
        b19.place(relx=0.75,rely=0.6)                
    ...
    def show_balance(self):
        ...
        l17=Label(f7,text="Enter Your PIN",font=("arial",15),bg="#fff",fg="royalblue")
        l17.place(relx=0.5,rely=0.05)
        self.e14=Entry(f7,font=("arial",15),highlightthickness=0,relief=FLAT,bg="#fff",fg="black",textvariable=self.pi)
        self.e14.place(relx=0.6,rely=0.05,width=300)
        c13=Canvas(f7,width=300,height=2,bg="black",highlightthickness=0)
        c13.place(relx=0.6,rely=0.08)
        def sb():
            self.pin=self.e14.get()
            db=sqlite3.connect("back.db")
            ...
            db.close()
            self.pi.set("")
        b16=Button(f7,text="Submit",bg="royalblue",fg="white",width=15,height=2,command=sb)
        b16.place(relx=0.85,rely=0.03)  
        b19=Button(f7,text="Back to Main Menu",bg="red",fg="white",width=20,height=2,command=self.show_main)
        b19.place(relx=0.75,rely=0.6)     
    ...
    def change_pin(self):
        ...
        l17=Label(f8,text="Enter Your Phone Number",font=("arial",18),bg="#fff",fg="royalblue")
        l17.place(relx=0.5,rely=0.05)
        ...
        c13=Canvas(f8,width=400,height=2,bg="black",highlightthickness=0)
        c13.place(relx=0.5,rely=0.13)
        l17=Label(f8,text="Enter Your PIN",font=("arial",18),bg="#fff",fg="royalblue")
        l17.place(relx=0.5,rely=0.2)
        ...
        c13=Canvas(f8,width=400,height=2,bg="black",highlightthickness=0)
        c13.place(relx=0.5,rely=0.28)
        self.pi2=StringVar()
        l17=Label(f8,text="Enter Your New PIN",font=("arial",18),bg="#fff",fg="royalblue")
        l17.place(relx=0.5,rely=0.35)
        ...
        def cp2():
            ...
            self.pi1.set("")
            self.pn1.set("")
        b16=Button(f8,text="Submit",bg="royalblue",fg="white",width=15,height=2,command=cp2)
        b16.place(relx=0.5,rely=0.5)
        b17=Button(f8,text="Back",bg="red",fg="white",width=15,height=2,command=self.show_main)
        b17.place(relx=0.65,rely=0.5)    
    ...
    def withd_money(self):
        ...
        l17=Label(f9,text="Enter Your PIN",font=("arial",18),bg="#fff",fg="royalblue")
        l17.place(relx=0.6,rely=0.2)
        ...
        c13=Canvas(f9,width=400,height=2,bg="black",highlightthickness=0)
        c13.place(relx=0.6,rely=0.3)
        self.wm=StringVar()
        l17=Label(f9,text="Enter Amount you want to withdraw ",font=("arial",18),bg="#fff",fg="royalblue")
        l17.place(relx=0.6,rely=0.35)
        ...
        def widm():
                ...
                self.wm.set("")         
                self.pi.set("")
        b16=Button(f9,text="Submit",bg="royalblue",fg="white",width=15,height=2,command=widm)
        b16.place(relx=0.6,rely=0.55)  
        b16=Button(f9,text="Back",bg="red",fg="white",width=15,height=2,command=self.show_main)
        b16.place(relx=0.7,rely=0.55)  

    def dep_money(self):
        f10=Frame(bg="#fff")
        f10.place(x=0,y=0,width=1500,height=988)
        Label(f10,image=img,border=0,bg='white').place(x=50,y=90) 
        l17=Label(f10,text="Enter Your PIN",font=("arial",18),bg="#fff",fg="royalblue")
        l17.place(relx=0.6,rely=0.2)
        self.e14=Entry(f10,font=("arial",18),highlightthickness=0,relief=FLAT,bg="#fff",fg="black",textvariable=self.pi)
        self.e14.place(relx=0.6,rely=0.27,width=400)
        c13=Canvas(f10,width=400,height=2,bg="black",highlightthickness=0)
        c13.place(relx=0.6,rely=0.3)
        self.dm=StringVar()
        l17=Label(f10,text="Enter Amount you want to deposit ",font=("arial",18),bg="#fff",fg="royalblue")
        l17.place(relx=0.6,rely=0.35)
        ...
        def dm():
            ...
            self.dm.set("")         
            self.pi.set("")
        b16=Button(f10,text="Submit",bg="royalblue",fg="white",width=15,height=2,command=dm)
        b16.place(relx=0.6,rely=0.55)  
        b16=Button(f10,text="Back",bg="red",fg="white",width=15,height=2,command=self.show_main)
        b16.place(relx=0.7,rely=0.55)  
    ...
    def close1(self):
        ...
        l4=Label(f11,text="Enter Your PIN",font=("arial",15),bg="#fff",fg="royalblue")
        l4.place(relx=0.5,rely=0.25)
        ...
        c3=Canvas(f11,width=400,height=2,bg="black",highlightthickness=0)
        c3.place(relx=0.5,rely=0.33)
        def delete():
            ...
            if self.pin == "" :
                ...
                db.commit()
                db.close()
                messagebox('Delete','Account Deleted Successfully')
            self.pi.set("")
        b4=Button(f11,text="Submit",bg="royalblue",fg="white",width=20,height=2,command=delete)
        b4.place(relx=0.6,rely=0.4)
        b16=Button(f11,text="Back",bg="red",fg="white",width=15,height=2,command=self.show_main)
        b16.place(relx=0.75,rely=0.4)  
...
def create_by_admin(m):
        ...
        e4=Entry(f13,font=("arial",15),highlightthickness=0,relief=FLAT,bg="#fff",fg="black",textvariable=n)
        e4.place(relx=0.55,rely=0.13,width=500)
        c3=Canvas(f13,width=500,height=2,bg="black",highlightthickness=0)
        c3.place(relx=0.55,rely=0.16)
        l6=Label(f13,text="Address",font=("arial",15),bg="#fff",fg="royalblue")
        l6.place(relx=0.05,rely=0.19)
        e5=Entry(f13,font=("arial",15),highlightthickness=0,relief=FLAT,bg="#fff",fg="black",textvariable=add)
        e5.place(relx=0.05,rely=0.22,width=500)
        ...
        e6=Entry(f13,font=("arial",15),highlightthickness=0,relief=FLAT,bg="#fff",fg="black",textvariable=pn)
        e6.place(relx=0.55,rely=0.22,width=500)
        ...
        e7=Entry(f13,font=("arial",15),highlightthickness=0,relief=FLAT,bg="#fff",fg="black",textvariable=g)
        e7.place(relx=0.05,rely=0.31,width=500)
        ...
        e8=Entry(f13,font=("arial",15),highlightthickness=0,relief=FLAT,bg="#fff",fg="black",textvariable=e)
        e8.place(relx=0.55,rely=0.31,width=500)
        ...
        e9=Entry(f13,font=("arial",15),highlightthickness=0,relief=FLAT,bg="#fff",fg="black",textvariable=p)
        e9.place(relx=0.05,rely=0.41,width=500)
        ...
        e10=Entry(f13,font=("arial",15),highlightthickness=0,relief=FLAT,bg="#fff",fg="black",textvariable=b)
        e10.place(relx=0.55,rely=0.41,width=500)
...
def delete_by_admin(m):
    ...
    def delete1():
        ...
        if pin=="":
            ...
            db=sqlite3.connect("back.db")
            cr=db.cursor()
            cr.execute("select * from account where  pin='"+ac.get()+"'")
            result = cr.fetchone()
            if result is None:
                db.close()
